...
<ion-item [formGroup]="formGroup">
  ...
  <ion-datetime displayFormat="YYYY-MM-DD HH:mm" pickerFormat="D MMM YYYY h:mm a" [formControlName]="config.key" [id]="config.key" [type]="config.stringFormat"></ion-datetime>
